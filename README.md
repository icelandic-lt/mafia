...
popd
```
Please mind off that the last step needs Python3.7 and therefore is not supported inside the NeMo containers. You have to find an alternative way to install the ctc_decoder dependency, e.g. via the alternative route outlined above.
